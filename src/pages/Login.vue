			...
			<div class="row d-flex justify-content-center align-items-center h-100">
				<div class="col-12 col-md-8 col-lg-8 col-xl-6">
					...
					<div class="card bg-dark text" style="color: var(--color-primary); border-radius: 1rem;">
						<div class="card-body p-5 text-center" style="background-color: var(--bg-secondary); position: relative; border-radius: 1rem;">
							...
							<form class="mb-md-5 mt-md-4 pb-5" @submit.prevent="submitLogin">
								...
								<h2 class="fw-bold mb-2 text-uppercase" style="color:var(--color-primary);">Login</h2>
								<p class="text-50 mb-5" style="color: var(--color-primary);;">Please enter your username and password!</p>

								<div class="form-outline form mb-4" style="color: var(--color-primary);;">
								...
								<div class="form-outline form mb-4" style="color: var(--color-primary);;">
									<input type="password" id="typePasswordX" class="form-control form-control-lg"
										style="color: var(--color-primary);; border-color: var(--color-primary);; background-color: var(--bg-secondary);"
										v-model="password" />
									<label class="form-label" for="typePasswordX" style="color: var(--color-primary);;">Password</label>
								</div>

								<button class="btn btn-outline btn-lg px-5" type="submit"
									style="color: var(--color-primary);; border-color: var(--color-primary);; background-color: var(--bg-secondary);">Login</button>
							</form>
							<div>
								<p class="mb-0" style="color: var(--color-primary);;">Don't have an account? <a href="/register"
										class="text-50 fw-bold " style="color: var(--color-primary);;">Sign Up</a>
								</p>
							</div>
						</div>
