				...
				<div class="col-12 col-md-8 col-lg-8 col-xl-6">
					...
					<div class="card bg-dark text" style="color: var(--color-primary); border-radius: 1rem;">
						<div class="card-body p-5 text-center"
							style="background-color: var(--bg-secondary); position: relative; border-radius: 1rem;">
							...
							<form class="mb-md-5 mt-md-4 pb-5" @submit.prevent="submitLogin">
								...
								<p class="text-50 mb-5" style="color: var(--color-primary);;">Please enter your username and
									password!</p>
								...
								<div class="form-outline form mb-4" style="color: var(--color-primary);;">
									<input type="username" id="typeEmailX" class="form-control form-control-lg"
										...
										v-model="username" />
									<label class="form-label" for="typetextX"
										style="color: var(--color-primary);;">Username</label>
								</div>
								...
								<div class="form-outline form mb-4" style="color: var(--color-primary);;">
									...
									<label class="form-label" for="typePasswordX"
										style="color: var(--color-primary);;">Password</label>
								</div>
							...
							<div>
								<p class="mb-0" style="color: var(--color-primary);;">Don't have an account? <a
										href="/register" class="text-50 fw-bold " style="color: var(--color-primary);;">Sign
										Up</a>
								</p>
							</div>
						</div>
