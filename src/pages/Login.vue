		...
		<div class="row d-flex justify-content-center align-items-center h-100" >
		  <div class="col-12 col-md-8 col-lg-8 col-xl-6" >
			<div class="card bg-dark text" style="color: #f1cc53; border-radius: 1rem;">
			  <div class="card-body p-5 text-center" style = "background-color: #272522;">
				...
				<div class="mb-md-5 mt-md-4 pb-5">
				  ...
				  <div class="form-outline form mb-4" style="color: #f1cc53;">
					<input type="email" id="typeEmailX" class="form-control form-control-lg" style="color: #f1cc53; border-color: #f1cc53; background-color: #272522;" />
					<label class="form-label" for="typetextX" style="color: #f1cc53;">Username</label>
				  </div>
  
				  <div class="form-outline form mb-4" style="color: #f1cc53;">
					<input type="password" id="typePasswordX" class="form-control form-control-lg" style="color: #f1cc53; border-color: #f1cc53; background-color: #272522;" />
					<label class="form-label" for="typePasswordX" style="color: #f1cc53;">Password</label>
				  </div>
  
				  <button class="btn btn-outline btn-lg px-5" type="submit" style="color: #f1cc53; border-color: #f1cc53; background-color: #272522;">Login</button>
				</div>
				<div>
				  <p class="mb-0" style="color: #f1cc53;">Don't have an account? <a href="/register" class="text-50 fw-bold " style="color: #f1cc53;">Sign Up</a>
				  </p>
				</div>
			  </div>
			</div>
