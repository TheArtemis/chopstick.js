            ...
            <div class="card-body p-5 text-center"
              ...
              <form class="mb-md-5 mt-md-4 pb-5" @submit.prevent="submitRegister">
                ...
                <div class="form-outline form mb-3" style="color: #f1cc53;  margin-top: -15px">
                  ...
                  <label class="form-label" for="typePassword1" style="color: #f1cc53;">Password</label>
                </div>
                <div class="form-outline form mb-3" style="color: #f1cc53;  margin-top: -15px">
                  <input type="password" id="typePassword2" class="form-control form-control-lg"
                    style="color: #f1cc53; border-color: #f1cc53; background-color: #272522;" v-model="confirmPassword" />
